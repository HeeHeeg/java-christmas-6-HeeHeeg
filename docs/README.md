...
- [ ] 방문 날짜를 입력받는 기능
  - [ ] 방문할 날짜는 1 이상 31 이하의 숫자로만 입력 받는 기능
  - [ ] 1 이상 31 이하의 숫자가 아닌 경우 "[ERROR] 유효하지 않은 날짜입니다. 다시 입력해 주세요." 메세지를 보여준 후 다시 입력받는 기능
- [ ] 메뉴는 쉼표(,)로 구분해서 입력받는 기능
- [ ] ‘-‘를 기준으로 앞에는 메뉴이름 뒤에는 개수로 저장되는 기능
- [ ] 주문 메뉴와 개수를 출력하는 기능
